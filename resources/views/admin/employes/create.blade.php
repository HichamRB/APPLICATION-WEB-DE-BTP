    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.employes.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-control {{ $errors->has('bank') ? 'is-invalid' : '' }}" name="bank" id="bank">
                    ...
                    @foreach(App\Models\Employe::BANK_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('bank', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('bank'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('rib') ? 'is-invalid' : '' }}" type="text" name="rib" id="rib" value="{{ old('rib', '') }}" required>
                @if($errors->has('rib'))
                    <div class="invalid-feedback">
                        {{ $errors->first('rib') }}
                    </div>
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-control {{ $errors->has('contract_type') ? 'is-invalid' : '' }}" name="contract_type" id="contract_type">
                    ...
                    @foreach(App\Models\Employe::CONTRACT_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('contract_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control date {{ $errors->has('job_start') ? 'is-invalid' : '' }}" type="text" name="job_start" id="job_start" value="{{ old('job_start') }}">
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control date {{ $errors->has('job_end') ? 'is-invalid' : '' }}" type="text" name="job_end" id="job_end" value="{{ old('job_end') }}">
