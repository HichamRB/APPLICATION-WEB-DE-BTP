    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.stocks.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('quantity_in') ? 'is-invalid' : '' }}" type="number" name="quantity_in" id="quantity_in" value="{{ old('quantity_in', '') }}" step="0.01">
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('quantity_out') ? 'is-invalid' : '' }}" type="number" name="quantity_out" id="quantity_out" value="{{ old('quantity_out', '') }}">
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control datetime {{ $errors->has('date_mvt') ? 'is-invalid' : '' }}" type="text" name="date_mvt" id="date_mvt" value="{{ old('date_mvt') }}">
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-control select2 {{ $errors->has('validate_by') ? 'is-invalid' : '' }}" name="validate_by_id" id="validate_by_id">
                    @foreach($validate_bies as $id => $entry)
                        <option value="{{ $id }}" {{ old('validate_by_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
