...
<body class="c-app">
    ...
    <div class="c-wrapper">
        <header class="c-header c-header-fixed px-3" style="background: #2eaacc">
            <button class="c-header-toggler c-class-toggler d-lg-none mfe-auto" type="button" data-target="#sidebar" data-class="c-sidebar-show" style="background: #696969;">
