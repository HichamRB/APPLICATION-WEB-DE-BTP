...
class StockApiController extends Controller
{
    public function index()
    {
        ...
        return new StockResource(Stock::with(['product', 'supplier', 'project', 'site', 'validate_by'])->get());
    }
    ...
    public function show(Stock $stock)
    {
        ...
        return new StockResource($stock->load(['product', 'supplier', 'project', 'site', 'validate_by']));
    }
